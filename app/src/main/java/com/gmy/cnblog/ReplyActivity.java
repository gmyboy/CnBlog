...
import com.gmy.cnblog.view.SendCommentButton;

/**
 * Created by Administrator on 2015/7/16.
 */
public class ReplyActivity extends AppCompatActivity implements SendCommentButton.OnSendClickListener {
...
//    private CommentsAdapter commentsAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            contentRoot.getViewTreeObserver().addOnPreDrawListener(
...
//                    commentsAdapter.setAnimationsLocked(true);
    ...
    private void startIntroAnimation() {
        ...
        contentRoot.animate().scaleY(1).setDuration(200)
                .setInterpolator(new AccelerateInterpolator())
                .setListener(new AnimatorListenerAdapter() {
                    @Override
                    public void onAnimationEnd(Animator animation) {
                        ViewCompat.setElevation(toolBar, StringUtil.dpToPx(8));
//                        animateContent();
                    }
                }).start();
    }
...
//    }
    ...
    public void onBackPressed() {
        ViewCompat.setElevation(toolBar, 0);
        contentRoot.animate().translationY(StringUtil.getScreenHeight(this))
                .setDuration(200).setListener(new AnimatorListenerAdapter() {
            @Override
            public void onAnimationEnd(Animator animation) {
                ReplyActivity.super.onBackPressed();
...
//        }
    ...
    private boolean validateComment() {
        if (TextUtils.isEmpty(etComment.getText())) {
            btnSendComment.startAnimation(AnimationUtils.loadAnimation(this,
                    R.anim.shake_error));
            return false;
        }
